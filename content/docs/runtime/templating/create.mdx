...
<Frame>
  ...
  >
    <source
      src="https://bun.com/docs/images/bun-create-shadcn.mp4"
...
<Callout type="info">By default Bun will _not overwrite_ any existing files. Use the `--force` flag to overwrite existing files.</Callout>
...
<Callout type="info">You can customize the global template path by setting the `BUN_CREATE_DIR` environment variable.</Callout>
...
<Accordion title={<span>How <code>bun create</code> works</span>} id="how-bun-create-works">
