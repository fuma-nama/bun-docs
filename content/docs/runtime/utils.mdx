...
<Callout type="info">~6,756x faster `string-width` alternative</Callout>
...
<Callout type="info">~6-57x faster `strip-ansi` alternative</Callout>
...
<Callout type="info">Drop-in replacement for `wrap-ansi` npm package</Callout>
