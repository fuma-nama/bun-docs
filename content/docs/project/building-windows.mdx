...
<Callout type="info">The Zig compiler is automatically downloaded, installed, and updated by the building process.</Callout>
...
<Callout type="info">Cygwin is not required for ARM64 builds as WebKit is provided as a pre-built binary.</Callout>
