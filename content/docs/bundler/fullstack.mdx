...
```html tab="public/dashboard.html"
<!DOCTYPE html>
<html>
  <head>
...
<Callout type="info">This is a work in progress. Features and APIs may change as Bun continues to evolve.</Callout>
