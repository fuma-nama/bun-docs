...
<Callout type="info">A huge thanks goes to the amazing work from the authors of LightningCSS and esbuild.</Callout>
...
```scss title="styles.module.css"
.button {
  color: red;
}
```

```scss title="other-styles.module.css"
.button {
  color: blue;
}
```
...
```scss title="background.module.css"
.background {
  background-color: blue;
}
```
