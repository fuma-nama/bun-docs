...
fullTitle: Deploy a Bun application on Railway
mode: center
---
...
<Callout type="info">Step 4 is only necessary if your application uses a database. If you don't need PostgreSQL, skip to Step 5.</Callout>
...
<Callout type="info">Step 2 is only necessary if your application uses a database. If you don't need PostgreSQL, skip to Step 3.</Callout>
